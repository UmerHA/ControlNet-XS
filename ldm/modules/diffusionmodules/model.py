...
def Normalize(in_channels):
    ...
    """
    if find_denominator(in_channels, 32) < 32:
        print(f'[USING GROUPNORM OVER LESS CHANNELS ({find_denominator(in_channels, 32)}) FOR {in_channels} CHANNELS]')
    # print(f'channels {channels} \tgroups{min(channels, 32)}')
    return GroupNorm_leq32(find_denominator(in_channels, 32), in_channels)
